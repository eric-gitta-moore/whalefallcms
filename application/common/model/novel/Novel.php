...
class Novel extends Model
{
    ...
    {
        return $this->belongsTo('Author','novel_author_id');
    }

    public function chapter()
    {
        return $this->hasMany('Chapter','novel_novel_id') -> order('weigh');
    }

    public function cate()
    {
        return $this->belongsToMany('app\common\model\config\Cate','novel_relation','config_cate_id','novel_novel_id');
    }
    ...
    {
        return $this->morphMany('\app\common\model\user\Buylog',['status','bookid'],'novel');
    }
}
