...
//自定义
if (!function_exists('build_form_tips'))
{
    /**
     * 生成表单提示信息
     * @param $tips
     * @return string
     */
    function build_form_tips($tips)
    {
        return "<span class=\"n-right\"><span class=\"msg-wrap n-tip\"><span class=\"n-icon\"></span><span class=\"n-msg\">$tips</span></span></span>";
    }
}
