define(['jquery', 'bootstrap', 'frontend', 'form', 'template',"layer","honeySwitch"], function ($, undefined, Frontend, Form, Template,layer) {
    ...
    var Controller = {
        ...
        index:function () {
            $(function () {
                ...
                $("#sign").on("click",function () {
                    let tips = layer.msg("签到中",{time:500});
                    $.get('/api/user/sign',{},function (data) {
                        // $("#msg_tips").remove();
                        layer.close(tips);
        ...
        help:function () {
            $(document).ready(function () {
                $('.qa-box > .item .head').on('click', function () {
