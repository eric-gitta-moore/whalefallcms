...
require(['../addons/bootstrapcontextmenu/js/bootstrap-contextmenu'], function (undefined) {
    if (Config.controllername == 'index' && Config.actionname == 'index' && (Config.modulename == 'admin' || Config.modulename == 'user')) {
        $("body").append(
            '<div id="context-menu">' +
        ...
        Form.events.bindevent = function (form) {
            ...
            $(".editor").each(function () {
                ...
                UE.list[id] = UE.getEditor(id, {
                    serverUrl: Fast.api.fixurl('/addons/ueditor/api/index/_ajax/1'),
