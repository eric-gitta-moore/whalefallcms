define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'novel/novel/index' + location.search,
                    add_url: 'novel/novel/add',
                    edit_url: 'novel/novel/edit',
                    del_url: 'novel/novel/del',
                    multi_url: 'novel/novel/multi',
                    table: 'novel',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'novel_author_id', title: __('Novel_author_id'),sortable:true,width:"110px"},
                            ...
                            buttons: [
                                {
                                    ...
                                    icon: 'fa fa-magic',
                                    url: 'novel/chapter/index/novel_novel_id/{id}',
                                },
                            ],
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'novel/novel/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
