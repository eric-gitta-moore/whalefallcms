define(['jquery', 'bootstrap', 'userend', 'addtabs', 'adminlte', 'form'], function ($, undefined, Userend, undefined, AdminLTE, Form) {
    var Controller = {
        index: function () {
            //双击重新加载页面
            ...
            $("form.sidebar-form").on('mousedown click', '.menuresult a[data-url]', function () {
                Userend.api.addtabs($(this).data("url"));
            });
            ...
            if (Config.referer) {
                if (Config.referer === $(addtabs).attr("url")) {
                    ...
                    //刷新页面后跳到到刷新前的页面
                    Userend.api.addtabs(Config.referer);
                }
            }
            ...
            function change_skin(cls) {
                if (!$("body").hasClass(cls)) {
                    ...
                    localStorage.setItem('userskin', cls);
            ...
            function setup() {
                var tmp = localStorage.getItem('userskin');
        ...
        login: function () {
            ...
            if (lastlogin) {
                ...
                $("#profile-img").attr("src", Userend.api.cdnurl(lastlogin.avatar));
            ...
            Form.api.bindevent($("#login-form"), function (data) {
                ...
                location.href = Userend.api.fixurl(data.url);
            });
        },
