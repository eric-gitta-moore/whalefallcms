define(['jquery', 'bootstrap', 'userend', 'table', 'form'], function ($, undefined, Userend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'user.agent.cartoon.cartoon/index' + location.search,
                    table: 'cartoon',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'cartoon_author_id', title: __('Cartoon_author_id')},
                        ...
                        {field: 'url', title: __('推广链接'), formatter:function (value, row, index)
                            {
                                ...
                                // console.log(row);
                                // console.log(index);
                                value = url + "index/cartoon.book/detail/id/" + row.id + "/pid/" + config.user.id;
                            ...
                            buttons: [
                                {
                                    ...
                                    icon: 'fa fa-magic',
                                    url: 'user.agent.cartoon.chapter/index/cartoon_cartoon_id/{id}',
                                },
                            ],
