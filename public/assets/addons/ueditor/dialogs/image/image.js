...
(function () {
    ...
    // fast 在线管理
    function FastOnlineImage() {
        this.init();

    }
    FastOnlineImage.prototype = {
        init: function () {
    ...
    UploadImage.prototype = {
        ...
        initUploader: function () {
            ...
            $upload.on('click', function () {
                ...
                if (state === 'ready') {
                    // uploader.upload();
                    editor.fireEvent("uploadBtn.click", uploader, editor);
                    return;
            ...
            editor.addListener("upload.success", function (e, id, pic, file) {
                var $file = $('#' + id);
