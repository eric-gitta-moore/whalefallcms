...
(function(){
    ...
    function createPreviewVideo(url){
        ...
        $G("preview").innerHTML = '<video class="previewVideo  vjs-default-skin   video-js" controls="" preload="auto" width="420" height="280" src="'+conUrl+'" data-setup="{}"></video>';
    ...
    UploadFile.prototype = {
        ...
        initUploader: function () {
            ...
            $upload.on('click', function () {
                ...
                if (state === 'ready') {
                    // uploader.upload();
                    editor.fireEvent("upload.video", uploader, editor);
            ...
            editor.addListener("video.file.success", function (e, id, pic, file) {
                var $file = $('#' + id);
